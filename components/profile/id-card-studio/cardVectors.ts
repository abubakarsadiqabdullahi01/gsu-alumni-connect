...
export const cardVectors = {
  ...
  front: {
    ...
    fullName: { x: 390, y: 300, fontSize: 33, fontWeight: 700, maxWidth: 390 },
    nameDivider: { x1: 330, y1: 310, x2: 800, y2: 310 },
    alumniNo: { x: 335, y: 382, fontSize: 25, label: "MEMBERSHIP NUMBER"},
    graduationYear: { x: 700, y: 382, fontSize: 25, label: "YEAR OF GRADUATION" },
    discipline: { x: 335, y: 478, fontSize: 25, label: "DISCIPLINE" },
    gender: { x: 700, y: 478, fontSize: 25, label: "GENDER" },
    qrX: 800,
    qrY: 420,
    qrSize: 140,
    holoX: 550,
